...
void Recoiler::SlaveBegin(TTree * /*tree*/)
{
  ...
  //if you want kinematic bins you must define fHisbins here
   fHisbins=new TH2F("Bins","Bins",10,300,1300,4,30,150);
...
//cout <<BeamHelicity_ << endl;

if(BeamHelicity_ == 1) {
//cout << "WA" << endl;
ScatteredWCPhiHel1 = scatteredTheta;
...
ScatteredWCPhiHel0 = scatteredTheta ;
...
void Recoiler::HistogramList(TString sLabel){
 ...
 // fOutput->Add(MapHist(new TH1F("ScatteredNucleonPhiHel1"+sLabel,"ScatteredNucleonPhiHel1"+sLabel,1000,-180,180))); 
  fOutput->Add(MapHist(new TH1F("ScatteredWCPhiHel1"+sLabel,"ScatteredWCPhiHel1"+sLabel,1000,-1500,200))); 
 // fOutput->Add(MapHist(new TH1F("ScatteredNucleonPhiHel0"+sLabel,"ScatteredNucleonPhiHel0"+sLabel,1000,-180,180))); 
  fOutput->Add(MapHist(new TH1F("ScatteredWCPhiHel0"+sLabel,"ScatteredWCPhiHel0"+sLabel,1000,-1500,200))); 
