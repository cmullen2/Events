...
//Latest
TFile* infile=new TFile("HelicityNDiff/60files/DiffCut/Perp/2Angular10Kin.root");
//TFile* infile=new TFile("HelicityNDiff/60files/DiffCut/Para/2Angular10Kin.root");
...
//  TFile* outfile=new TFile("HelicityNDiff/Perp/BGSub2Angular10Kin.root","recreate");
  ...
  TFile* outfile=new TFile("HelicityNDiff/60files/DiffCut/Perp/BGSub2Angular10Kin.root","recreate");
//  TFile* outfile=new TFile("HelicityNDiff/60files/DiffCut/Para/BGSub2Angular10Kin.root","recreate");
...
//  TFile* neutronout = new TFile("HelicityNDiff/Perp/ProSubBGSub2Angular10Kin.root","recreate"); 
  ...
  TFile* neutronin = new TFile("HelicityNDiff/60files/DiffCut/Perp/BGSub2Angular10Kin.root"); 
  TFile* neutronout = new TFile("HelicityNDiff/60files/DiffCut/Perp/ProSubBGSub2Angular10Kin.root","recreate"); 

//  TFile* neutronin = new TFile("HelicityNDiff/60files/DiffCut/Para/BGSub2Angular10Kin.root"); 
//  TFile* neutronout = new TFile("HelicityNDiff/60files/DiffCut/Para/ProSubBGSub2Angular10Kin.root","recreate"); 
