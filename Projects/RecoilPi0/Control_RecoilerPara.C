{
  ...
  // tree->Add("/scratch/chris/RealData/ChrisGoatOut/Run14920/Physics_CBTaggTAPS_14920.root");
  
  // tree->Add("/scratch/chris/RealData/ChrisGoatOut/Run14922/Physics_CBTaggTAPS_14922.root");
  // tree->Add("/scratch/chris/RealData/ChrisGoatOut/Para/Physics_CBTaggTAPS_*.root");
...
//		   "/home/chris/Events/Projects/RecoilPi0/HelicityNDiff/Para/2Angular10Kin.root");
   ...
   gSystem->Setenv("HSOUT",
		   "/home/chris/Events/Projects/RecoilPi0/HelicityNDiff/60files/DiffCut/Para/NoBinsHighStatTesting.root");
